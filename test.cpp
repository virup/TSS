...
int main(int argc, char* argv[])
{
    ...
    char *regionGrammar =
        "<region:SO> -= <regionLabel:S><face:SO>[]<index:SO>;"
//        "<region:SO> -= <face:SO>[]<index:SO>;"
        "<face:SO>   -= <outerCycle:SO><holeCycle:SO>[];"
        "<index:SO>  -= <segmentIndex:RO>[];"
	...
	cout << "hi" << endl;
	//Path pregionlabel = t.createPath("region.regionLabel");
    ...
    try{
        pface0OSeg0.setDoubleArray(f0OSeg0,sizeof(f0OSeg0));
        pface0OSeg1.setDoubleArray(f0OSeg1,sizeof(f0OSeg1));
        pface0OSeg2.setDoubleArray(f0OSeg2,sizeof(f0OSeg2));
        pface0OSeg3.setDoubleArray(f0OSeg3,sizeof(f0OSeg3));

        pface0HSeg0.setDoubleArray(f0HSeg0,sizeof(f0HSeg0));
        pface0HSeg1.setDoubleArray(f0HSeg1,sizeof(f0HSeg1));
        pface0HSeg2.setDoubleArray(f0HSeg2,sizeof(f0HSeg2));

        pface1OSeg0.setDoubleArray(f1OSeg0,sizeof(f1OSeg0));
        pface1OSeg1.setDoubleArray(f1OSeg1,sizeof(f1OSeg1));
        pface1OSeg2.setDoubleArray(f1OSeg2,sizeof(f1OSeg2));
    }
    catch(...)
    {
        cout<<"error";
    ...
    Path pp = t.createPath("region.face[2].outerCycle.segment[1]");

    // READ BACK THE VALUE FROM face[0].outerCycle.Segment[1]
    try{
        pface0OSeg1.readDoubleArray(p,sizeof(p));
